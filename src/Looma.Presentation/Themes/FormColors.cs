...
{
    public string? FormDividerBrush { get; set; }
    public string? FormControlBackgroundBrush { get; set; }
    ...
    public string? FormOptionHoverForegroundBrush { get; set; }
    public string? ColorPickerContainerBackgroundBrush { get; set; }
    public string? ColorPickerContainerBorderBrush { get; set; }
}
